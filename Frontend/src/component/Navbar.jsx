...
const Navbar = ({ isOpen, setIsOpen }) => {
  ...
  return (
    <nav className="h-[56px] bg-slate-800 p-4 flex items-center justify-between sticky top-0 z-40 shadow-2xl">
      ...
      <div className="flex items-center gap-4">
        ...
        >
          <span className=" hidden md:block">{user?.first_name || 'Loading...'}</span>
